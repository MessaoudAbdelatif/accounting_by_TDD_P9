...
import com.dummy.myerp.consumer.dao.impl.db.rowmapper.comptabilite.SequanceEcritureComptableRM;
...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
  ...
  public void loadListLigneEcriture(EcritureComptable pEcritureComptable) {
    ...
    List<LigneEcritureComptable> vList = vJdbcTemplate
        .query(SQLloadListLigneEcriture, vSqlParams, vRM);
  ...
  /**
   * SQLupdateSéquenceEcritureComptable
   **/
  ...
  public void updateSequenceEcritureComptable(SequenceEcritureComptable sequenceEcritureComptable) {
    NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(
        getDataSource(DataSourcesEnum.MYERP));
    MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
    vSqlParams.addValue("journal_code", sequenceEcritureComptable.getJournalCode().getCode());
  ...
  // ==================== SéquenceEcritureComptable - INSERT ====================
  /**
   * SQLinsertSéquenceEcritureComptable
   **/
...
@Override
  public void deleteSequenceEcritureComptable(String journalCode,Integer year) {
