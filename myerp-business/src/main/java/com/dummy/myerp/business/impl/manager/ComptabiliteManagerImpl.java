 ...
 */
public class ComptabiliteManagerImpl extends AbstractBusinessManager implements
    ComptabiliteManager {
...
//    getDaoProxy().getComptabiliteDao().updateEcritureComptable(pEcritureComptable);
   ...
   * indépendemment du contexte (unicité de la référence, exercie comptable non cloturé...)
   *
  ...
  protected void checkEcritureComptableUnit(EcritureComptable pEcritureComptable)
    ...
    int vNbrCredit = 0;
    int vNbrDebit = 0;
    for (LigneEcritureComptable vLigneEcritureComptable : pEcritureComptable
        .getListLigneEcriture()) {
    ...
    //    de l'année et d'un numéro de séquence (propre à chaque journal) sur 5 chiffres incrémenté automatiquement à chaque écriture.
...
//      00001
   ...
   * la référence, année comptable non cloturé...)
   *
   * @param pEcritureComptable -
   * @throws FunctionalException Si l'Ecriture comptable ne respecte pas les règles de gestion
   */
  protected void checkEcritureComptableContext(EcritureComptable pEcritureComptable)
      throws FunctionalException {
